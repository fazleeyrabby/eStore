<aside class="sidebar">
    <div class="scroll-sidebar">
        <div class="user-profile">
            <div class="dropdown user-pro-body">
                <div class="profile-image">
                    <img src="{{ asset('/public/assets/backend/plugins/images/users/hanna.jpg') }}" alt="user-img" class="img-circle">
        ...
        <nav class="sidebar-nav">
            <ul id="side-menu">
                <li>
                    <a href="{{ url('/admin/dashboard') }}" aria-expanded="false"><i class="icon-calender fa-fw"></i> <span class="hide-menu"> Dashboard</span></a>
                </li>
                 <li>
                    <a href="{{ route('user.all') }}" class="app-menu__item {{ session('menu') == 'allUser' ? 'active' : '' }}" aria-expanded="false"><i class="fa fa-user fa-lg"></i> <span class="hide-menu"> User </span></a>
                </li> 
                <li>
                    <a class="active waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-basket fa-fw"></i> <span class="hide-menu"> Slider </span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li> <a href="index4.html">Create</a> </li>
                        <li> <a href="products.html">Manage</a> </li>
                    </ul>
                </li>
                <li>
                    <a class="active waves-effect" href="javascript:void(0);" ><i class="icon-basket fa-fw"></i> <span class="hide-menu"> Product </span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li> <a href="{{ url('admin/product/create') }}">Create</a> </li>
                        <li> <a href="{{ url('admin/product/manage') }}">Manage</a> </li>
                    </ul>
                </li>
                <li>
